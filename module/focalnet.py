...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=(224, 224), patch_size=4, in_chans=3, embed_dim=96, use_conv_embed=False, norm_layer=None, is_stem=False):
        ...
        if use_conv_embed:
            ...
            self.proj = nn.Conv2d(in_chans, embed_dim, kernel_size=(2,2), stride=(2,2),padding=(0,0))
    ...
    def __init__(self, 
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(dim=embed_dim[i_layer], 
                               ...
                               norm_layer=norm_layer, 
                               downsample=PatchEmbed if (i_layer < self.num_layers - 2) else None, # replace 1 with 2
